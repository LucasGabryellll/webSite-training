...
jQuery.migrateMute === void 0 && (jQuery.migrateMute = !0),
    function (e, t, n) {
        function r(n) {
            var r = t.console; i[n] || (i[n] = !0,
                e.migrateWarnings.push(n), r && r.warn && !e.migrateMute && (r.warn("JQMIGRATE: " + n),
            ...
            if (Object.defineProperty)
                try {
                    return Object.defineProperty(t, a, {
                        ...
                        get: function () { return r(o), i }, set: function (e) { r(o), i = e }
                    }), n
                ...
                return u && (4 > s.length && r("jQuery.fn.attr( props, pass ) is deprecated"),
                    t && !d.test(g) && (o ? a in o : e.isFunction(e.fn[a]))) ? e(t)[a](i) : ("type" === a && i !== n && l.test(t.nodeName) && t.parentNode && r("Can't change the 'type' of an input or button in IE 6/7/8"),
                        !e.attrHooks[c] && p.test(c) && (e.attrHooks[c] = {
                            ...
                            set: function (t, n, r) {
                                var a; return n === !1 ? e.removeAttr(t, r) : (a = e.propFix[r] || r, a in t && (t[a] = !0),
        ...
        e.fn.init = function (t, n, a) {
            ...
            e.browser || (g = e.uaMatch(navigator.userAgent),
                h = {}, g.browser && (h[g.browser] = !0, h.version = g.version),
            ...
            e.sub = function () {
                ...
                e.extend(!0, t, this), t.superclass = this, t.fn = t.prototype = this(),
        ...
        var b = e.fn.data; e.fn.data = function (t) {
            ...
            return !o || "events" !== t || 1 !== arguments.length || (a = e.data(o, t), i = e._data(o, t),
                a !== n && a !== i || i === n) ? b.apply(this, arguments) : (r("Use of jQuery.fn.data('events') is deprecated"), i)
        }
        ...
        e.event.props && "attrChange" !== e.event.props[0] && e.event.props.unshift("attrChange", "attrName", "relatedNode", "srcElement"),
            ...
            e.fn.error = function () {
                ...
                return r("jQuery.fn.error() is deprecated"), e.splice(0, 0, "error"),
            ...
            e.fn.toggle = function (t, n) {
                ...
                var a = arguments, i = t.guid || e.guid++, o = 0, s = function (n) {
                    ...
                    return e._data(this, "lastToggle" + t.guid, r + 1),
                        n.preventDefault(), a[r].apply(this, arguments) || !1
                };
